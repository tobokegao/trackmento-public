...
.venv/Scripts/python cli.py add    --url "https://xxx.bandcamp.com/track/..." [--grid NAME]     # Bandcamp / SoundCloud / YouTube / ニコニコ動画の URL
...
4. 見つからない場合の順に: `--source discogs` / `--source mb` → Bandcamp / SoundCloud / YouTube / ニコニコ動画なら URL をもらって `--url URL` → 画像 URL をもらって `--image URL --artist --title`
