...
<li><b>Add from a list, or copy one:</b> Enter track and artist names in the table under “From a list of track names” and each
...
<li><b>トラック名の一覧から入れる・コピーする：</b>検索の「トラック名の一覧から」の表にトラック名とアーティスト名を入れると、iTunesで1行ずつ探してまとめて入れられます（一度に20行まで。Excelなどの表も貼れます）。逆に「トラック名をコピー」で、並びを「1. トラック名 / アーティスト」の文章にしてコピーできます。</li>
...
CHANGES: list[tuple[str, str, str]] = [
    ("2026-09-23", "トラック名とアーティスト名の表から、まとめて入れられるようになりました（検索の「トラック名の一覧から」、一度に 20 行まで）。Excel などの表も貼れます。逆に「トラック名をコピー」で、並びを「1. トラック名 / アーティスト」の文章にしてコピーできます。",
     "You can now add tracks all at once from a table of track and artist names (“From a list of track names” under Search, up to 20 rows at a time). You can also paste from a spreadsheet such as Excel. In the other direction, “Copy track names” copies the layout as text in the form “1. Track / Artist”."),
