...
CHANGES: list[tuple[str, str, str]] = [
    ("2026-09-22", "スマホで画面を拡大したとき、スライダーのつまみの枠線がずれたり二重に見えたりしていたのを直しました。",
     "Fixed slider thumbs whose outline could look misaligned or doubled when you zoomed in on a phone."),
