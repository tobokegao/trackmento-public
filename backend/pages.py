...
CHANGES: list[tuple[str, str, str]] = [
    ("2026-09-25", "「ジャケットに近い色」「ジャケットと反対の色」で、ジャケットから取った色の候補を四角で並べ、押して選べるようにしました。「画像」を選ぶと、まず TRACKMENTO の模様が敷かれます（「画像を選ぶ…」で好きな画像に替えられます）。",
     "“Match the covers” and “Contrast the covers” now show the colors taken from your covers as squares you can pick from. Choosing “Image” first lays the TRACKMENTO pattern (switch to any image with “Choose an image…”)."),
