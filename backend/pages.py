...
CHANGES: list[tuple[str, str, str]] = [
    ("2026-09-22", "スマホで画面を拡大したとき、スライダーとスクロールバーのつまみの枠線がずれたり二重に見えたりしていたのを直しました。横のスクロールバーのつまみの縞が 1 本しか出ていなかったのも直しています。",
     "Fixed slider and scrollbar thumbs whose outline could look misaligned or doubled when you zoomed in on a phone. The grip on horizontal scrollbar thumbs, which showed only one line, is fixed too."),
