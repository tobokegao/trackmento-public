...
TEXT = {
    "ja": {
        ...
        "find_note": "曲名やアーティスト名で、その曲が入っているグリッドを探せます。",
        "find_opt": "ここに出るのは、共有するときに「みんなのグリッドから探せるようにする」にチェックを入れたものだけです（既定は入っていません）。ほかの共有は URL を知っている人だけが見られます。",
        "find_ph": "曲名・アーティスト名",
        "find_btn": "探す",
    ...
    "en": {
        ...
        "find_note": "Search by song or artist name to find grids that contain that track.",
        "find_opt": "Only grids whose maker ticked “Let people find this grid” when sharing appear here (it is off by default). Every other share stays visible only to people who have its URL.",
