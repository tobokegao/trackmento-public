...
body {{ margin: 0; background: #f1efe4; color: #12171b; font-family: "IBM Plex Sans JP", sans-serif; line-height: 1.55; }}
...
.btn {{ display: inline-flex; align-items: center; min-height: 44px; padding: 4px 16px; border: 2px solid #12171b; background: #f1efe4; color: #12171b;
  font-family: "DotGothic16", sans-serif; text-decoration: none; box-shadow: 2px 2px 0 #12171b; }}
.btn.primary {{ background: #12171b; color: #f1efe4; }}
