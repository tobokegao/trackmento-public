"""TRACKMENTO CLI。Claude Code（Remote Control でスマホから）が Bash で叩く想定。
  ...
  python cli.py add    --url URL [--grid NAME]                            # Bandcamp / SoundCloud / YouTube / ニコニコ動画の URL
...
SOURCE_LABEL = {"itunes": "iTunes", "musicbrainz": "MusicBrainz", "discogs": "Discogs", "bandcamp": "Bandcamp", "soundcloud": "SoundCloud", "youtube": "YouTube", "nicovideo": "ニコニコ動画", "manual": "手入力"}
MAX_CANDIDATES = 8
...
def cmd_add(a: argparse.Namespace) -> int:
    ...
    if url:
        from backend.sources import fromurl
...
def build_parser() -> argparse.ArgumentParser:
    ...
    sp.add_argument("--url", "-u", metavar="URL", help="Bandcamp / SoundCloud / YouTube / ニコニコ動画のページ URL")
